...
export default {
  ...
  methods: {
    ...
    text-align:left!important;'>`;
            ...
            // 扩展权限动态判断
            console.log('66',that.extraList,item.menuId,that.extraMenuID);
            console.log($.inArray(item.menuId,that.extraMenuID))
