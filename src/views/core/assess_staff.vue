  ...
  <div style="padding:20px;height:100%">
    <div class="tableBox" style="height:95%;background:#fff;padding:5px;">
      ...
      >
        ...
        <el-table-column prop="proTitle" label="职称" sortable width="200"></el-table-column>
        ...
        <el-table-column prop="education" label="学历" sortable width="200"></el-table-column>
        <el-table-column prop="degree" label="学位" sortable width="200"></el-table-column>
        <el-table-column prop="workingYears" label="工龄" sortable width="200"></el-table-column>
              ...
              >
                ...
                <el-form-item label="人员类别" prop="userClass" width="200">
                  <el-radio-group v-model="ruleForm.userClass">
                    <el-radio value="1" label="评估员A"></el-radio>
                    <el-radio value="2" label="评估员B"></el-radio>
                  </el-radio-group>
                </el-form-item>
                <el-form-item label="评估等级" prop="assessLevel" width="200">
                  <el-col :span='10'>
                  <el-select
                    clearable
                    placeholder="请选择"
      ...
      <!-- 详情模态框 -->
      <el-dialog title="评估机构人员详细资料" :visible.sync="dialogVisible2" width="1024px" top="50px">
        <el-tabs v-model="detailTabActive" @tab-click="detailTabClick">
          <el-tab-pane label="人员基本信息" name="detailBaseInfo">
            <div style="height:660px;overflow:auto">
              <el-form :model="detailForm" label-width="150px" class="demo-ruleForm" disabled label-position="left">
                <!-- <el-form-item>模态框状态{{modelType}}</el-form-item> -->
                <el-form-item label="登录账号" prop="account" width="200">
                  <el-col :span="20">
  ...
  methods: {
    ...
    getData() {
      this.$axios({
        ...
        }&empnoLike=${encodeURI(this.searchForm.empno)}&userType=2&pageNo=${
          this.currentPage
    ...
    dataList(tableData) {
      ...
      data.forEach((item, index) => {
        ...
        item.userClass = item.userClass == 1 ? "评估员A" : "评估员B";
      });
      this.lists = data;
    },
    addData() {
    ...
    updateData() {
      if (this.checkData.length != 1) {
        ...
        let data = {
          ...
          branchBankName:check.branchBankName,
          branchBankNumber:check.branchBankNumber,
          degree: check.degree,
    ...
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          data.userClass = data.userClass == "评估员A" ? 1 : 2;
          data.userType = 2;
    ...
    handleCurrentChange(val) {
      ...
      this.$axios({
        ...
        }&userType=2&pageNo=${val}&pageSize=${this.changePageSize}`,
        method: "get"
      }).then(res => {
        this.total = res.data.totalCount;
        this.currentPage = res.data.curPage;
    ...
    getReloadData(that) {
      that
        .$axios({
          ...
          }&empnoLike=${encodeURI(that.searchForm.empno)}&userType=2&pageNo=${
            that.currentPage
      ...
      for (let i = 0; i < menu.length; i++) {
        if (menu[i].name == "人员管理") {
          ...
          for (let j = 0; j < submenu.length; j++) {
            if (submenu[j].component == "core/assess_staff") {
              console.log("评估机构人员", submenu[j]);
              // urlRole1==dataAdd 增
