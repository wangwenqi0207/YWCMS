    ...
    <div class="tableBox" style="height:95%;background:#fff;padding:5px;">
      ...
      >
        <el-form-item label="登录账号：">
          <el-input v-model.trim="searchForm.account" clearable></el-input>
        </el-form-item>
        <el-form-item label="姓名：" label-width="80px" span="5">
          <el-input v-model.trim="searchForm.fullname" clearable></el-input>
        </el-form-item>
        <el-form-item label="工号：">
          <el-input v-model.trim="searchForm.empno" clearable></el-input>
        </el-form-item>
        <el-form-item label="身份证号：">
          <el-input v-model.trim="searchForm.idNo" clearable></el-input>
        </el-form-item>
      ...
      >
        ...
        <el-table-column prop="userId" label="序号" width="100" sortable></el-table-column>
        <el-table-column prop="account" label="登录账号" width="150" sortable></el-table-column>
        <el-table-column prop="idNo" label="身份证号" width="180" sortable></el-table-column>
        <el-table-column prop="empno" label="工号" width="150" sortable></el-table-column>
        <el-table-column prop="fullname" label="姓名" width="150" sortable></el-table-column>
        <el-table-column prop="gender" label="性别" width="150" sortable></el-table-column>
        <el-table-column prop="userClass" label="人员分类" width="150" sortable></el-table-column>
        <el-table-column prop="orgName" label="所属机构" width="220" sortable></el-table-column>
        <el-table-column prop  = "position" label = "职位" sortable width = "200"></el-table-column>
        <el-table-column prop="proTitle" label="职称" sortable width="120"></el-table-column>
        <el-table-column prop="workPhone" label="工作电话" sortable width="200"></el-table-column>
        <el-table-column prop="homePhone" label="私人电话" sortable width="200"></el-table-column>
        <el-table-column prop="education" label="学历" sortable width="150"></el-table-column>
        <el-table-column prop="degree" label="学位" sortable width="120"></el-table-column>
        <el-table-column prop="workingYears" label="工龄" sortable width="120"></el-table-column>
        <el-table-column prop="address" label="联系地址" sortable width="200"></el-table-column>
        <el-table-column prop="status" label="状态" sortable width="200"></el-table-column>
        <el-table-column prop="bankAccountName" label="银行户名" sortable width="200"></el-table-column>
        <el-table-column
          ...
          width = "200"
        ></el-table-column>
        <el-table-column prop="branchBankName" label="银行支行名称" sortable width="200"></el-table-column>
        <el-table-column prop="branchBankNumber" label="银行支行号（支行代码）" sortable width="200"></el-table-column>
        <el-table-column prop="bankAccountArea" label="开户银行区域" sortable width="200"></el-table-column>
      ...
      >
        <el-tabs v-model="activeName" @tab-click="tabClick">
          <el-tab-pane label="人员基本信息" name="baseInfoTab">
            <div style="height:660px;overflow:auto">
              ...
              >
                ...
                <el-form-item label="登录账号" prop="account" width="200">
                  <el-col :span="10">
                    <el-input v-model="ruleForm.account"></el-input>
                  </el-col>
                </el-form-item>
                <el-form-item label="密码" prop="passwd" width="200">
                  <el-col :span="10">
                    <el-input v-model="ruleForm.passwd"></el-input>
                  </el-col>
                </el-form-item>
                <el-form-item label="身份证号码" prop="idNo" width="200">
                  <el-col :span="10">
                ...
                <el-form-item label="姓名" prop="fullname" width="200">
                  <el-col :span="10">
                ...
                <el-form-item label="人员类别" prop="userClass" width="200">
                  <el-radio-group v-model="ruleForm.userClass">
                    <el-radio value="1" label="护理员"></el-radio>
                    <el-radio value="2" label="护士"></el-radio>
                  </el-radio-group>
                  <el-checkbox v-model="ruleForm.member">家属人员</el-checkbox>
                </el-form-item>
                <el-form-item label="护理等级" prop="assessLevel" width="200">
                  <el-col :span='10'>
                  <el-select
                    clearable
                    placeholder="请选择"
                    size="mini"
                    v-model="ruleForm.assessLevel"
                    id="assessLevel"
                    style="width:100%;"
                  >
                ...
                <el-form-item label="所属机构" prop="org" width="200">
                  <el-col :span='10'>
                  <el-select clearable placeholder="请选择" size="mini" v-model="ruleForm.org" id="orgName" style="width:100%;">
                    <el-option
                ...
                <el-form-item label="职位" prop="position" width="200">
                  <el-col :span="10">
                    <el-input v-model="ruleForm.position"></el-input>
                  </el-col>
                </el-form-item>
                <el-form-item label="职称" prop="password" width="200">
                  <el-col :span="10">
                ...
                <el-form-item label="私人电话" prop="homePhone" width="200">
                  <el-col :span="10">
                    <el-input v-model="ruleForm.homePhone"></el-input>
                  </el-col>
                </el-form-item>
                <el-form-item label="学历" prop="education" width="200">
                  <el-col :span="10">
                    <el-input v-model="ruleForm.education"></el-input>
                  </el-col>
                </el-form-item>
                <el-form-item label="学位" prop="degree" width="200">
                  <el-col :span="10">
                    <el-input v-model="ruleForm.degree"></el-input>
                  </el-col>
                </el-form-item>
                <el-form-item label="工龄" prop="workingYears" width="200">
                  <el-col :span="10">
                ...
                >
                  <el-select clearable placeholder="请选择" size="mini" v-model="bankProvince">
                    <el-option
                  ...
                  <el-select clearable placeholder="请选择" size="mini" v-model="bankCity">
                    <el-option
          ...
          <el-tab-pane label="人员资质&合同" name="qualification">人员资质&合同</el-tab-pane>
          <el-tab-pane label="健康档案&健康数据" name="heath">健康档案&健康数据</el-tab-pane>
          <el-tab-pane label="积分记录" name="creditsLog">积分记录</el-tab-pane>
          <el-tab-pane label="工单记录" name="orderLog">工单记录</el-tab-pane>
          <el-tab-pane label="工资记录" name="payrollLog">工资记录</el-tab-pane>
        </el-tabs>
      </el-dialog>
      <!-- 详情模态框 -->
      <el-dialog title="护理机构人员详细资料" :visible.sync="dialogVisible2" width="1024px" top="50px">
        <el-tabs v-model="detailTabActive" @tab-click="detailTabClick">
          <el-tab-pane label="人员基本信息" name="detailBaseInfo">
            <div style="height:660px;overflow:auto">
              <el-form :model="detailForm" label-width="150px" class="demo-ruleForm" disabled>
                ...
                <el-form-item label="人员类别" prop="userClass" width="200">
                  ...
                  <el-checkbox v-model="detailForm.member">家属人员</el-checkbox>
                </el-form-item>
                <el-form-item label="护理等级" prop="assessLevel" width="200">
                  <el-col :span='20'>
                  <el-select
                    ...
                    placeholder="请选择"
                    size="mini"
                    v-model="detailForm.assessLevel"
                    id="assessLevel"
                    style="width:100%;"
                  >
                    <el-option value="1"></el-option>
                ...
                <el-form-item label="所属机构" prop="org" width="200">
                  <el-col :span='20'>
                  <el-select clearable placeholder="请选择" size="mini" v-model="detailForm.org" id="orgName" style="width:100%;">
                    <el-option
                      v-for="(item,index) in orgArray"
                      :value="item.orgId"
                      :label="item.orgName"
                ...
                <el-form-item label="开户银行区域" prop="bankAccountArea" width="200">
                  <el-select clearable placeholder="请选择" size="mini" v-model="bankProvince">
                    <el-option
                      v-for="(item,index) in bankProvinceL"
                      :value="item.regionId"
...
export default {
  ...
  data() {
    return {
      module: "staff_nursing_service_mng",
      dialogVisible: false,
      dialogVisible2: false,
      dialogTitile: "新增人员信息",
      activeName: "baseInfoTab",
      detailTabActive: "detailBaseInfo",
      modelType: 1,
      searchForm: {
        account: "",
        fullname: "",
      ...
      rules: {
        account: [
          ...
          {
            pattern: /[a-zA-Z0-9]{1,10}@[a-zA-Z0-9]{1,5}\.[a-zA-Z0-9]{1,5}|^1[34578][0-9]{9}/,
            message: "账户只能邮箱或者手机号",
            trigger: "blur"
          }
        ],
  ...
  methods: {
    ...
    getData() {
      this.$axios({
        ...
        }&empnoLike=${encodeURI(this.searchForm.empno)}&userType=4&pageNo=${
          this.currentPage
    ...
    dataList(tableData) {
      ...
      data.forEach((item, index) => {
        ...
        item.userClass = item.userClass == 1 ? "护理员" : "护士";
      });
      this.lists = data;
    },
    addData() {
      ...
      this.modelType = 1;
      this.dialogTitile = "新增护理机构人员";
      this.activeName = "baseInfoTab";
      this.ruleForm = {
        id: "",
        orderStr: "",
        orgLinks: "",
    ...
    updateData() {
      if (this.checkData.length != 1) {
        ...
        let data = {
          ...
          member: check.member == 1 ? true : false
        };
    ...
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          data.userClass = data.userClass == "护理员" ? 1 : 2;
          data.member = data.member == true ? 1 : 0;
          data.userType = 4;
    ...
    protocolDetails(index, rowData) {
      ...
      this.detailTabActive = "detailBaseInfo";
    ...
    handleCurrentChange(val) {
      this.$axios({
        ...
        }&userType=4&pageNo=${val}&pageSize=${this.changePageSize}`,
        method: "get"
      }).then(res => {
        this.total = res.data.totalCount;
        this.currentPage = res.data.curPage;
    ...
    getReloadData(that) {
      that
        .$axios({
          ...
          }&empnoLike=${encodeURI(that.searchForm.empno)}&userType=4&pageNo=${
            that.currentPage
      ...
      for (let i = 0; i < menu.length; i++) {
        if (menu[i].name == "人员管理") {
          ...
          for (let j = 0; j < submenu.length; j++) {
            if (submenu[j].component == "core/nursing_staff") {
              console.log("护理机构人员", submenu[j]);
              // urlRole1==dataAdd 增
