            ...
            <div>
              <el-container style="height:660px;overflow:auto;width:100%">
                <el-form
                  ...
                  style="width:60%;text-align:left;margin-left:30px;"
          ...
          <el-tab-pane v-if="baseInfoForm.orgType==4" label="床位信息">
            ...
            <el-container>
              ...
              >
                ...
                <el-table-column prop="bedType" label="类型" show-overflow-tooltip>
                  <template slot-scope="scope">
                    <div v-if="scope.row.bedType==1">
                      标准
                    </div>
                    <div v-else-if="scope.row.bedType==2">
                      救济
                    </div>
                    <div v-else>
                      其它
            ...
            <el-container>
              ...
              >
                <el-form-item label="房间号">
                  <el-input v-model="bedInfoForm.roomNo" clearable :disabled="rommDis"></el-input>
                </el-form-item>
                <el-form-item label="床位号">
                  <el-input v-model="bedInfoForm.bedNo" clearable :disabled="rommDis"></el-input>
                </el-form-item>
  ...
  data() {
    let validateOrgCode=(rule, value, callback)=>{
          ...
          if(this.oldOrgCode && value==this.oldOrgCode){
            ...
            this.$axios({
              url   : `${this.$store.state.globalRouter}/auth/organization/organization_apply_mng/is_exist`,
              method: "get",
              params:data
            }).then(res => {
            if(res.data.data){
        ...
        this.$axios({
          ...
          if (res.data.resultCode == "000000") {
            ...
            this.baseInfoForm.legalRepresentativePhone =
              parseInt(data.legalRepresentativePhone);
            this.baseInfoForm.managingStaffName = data.managingStaffName;
            this.baseInfoForm.managingStaffPhone = parseInt(data.managingStaffPhone);
